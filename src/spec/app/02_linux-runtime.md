...
[[src/target/linux_aarch64/gtk.rs:emit_app_program_entry]]
...
[[src/target/linux_aarch64/gtk.rs:FINISH_SYMBOL]]
[[src/target/linux_aarch64/gtk.rs:MAIN_SYMBOL]]
...
(`branch_self` guards the tail). [[src/target/linux_aarch64/gtk.rs:emit_libc_start_trampoline]]
...
[[src/target/linux_aarch64/gtk.rs:emit_main_bootstrap]]
...
[[src/target/linux_aarch64/gtk.rs:emit_activate_handler]]
...
[[src/target/linux_aarch64/gtk.rs:emit_worker_shim]]
...
`size = STATE_SIZE`. [[src/target/linux_aarch64/gtk.rs:STATE_SYMBOL]]
[[src/target/linux_aarch64/gtk.rs:app_mode_data_objects]]
...
throughout the term code. [[src/target/linux_aarch64/gtk.rs:state_array]]
...
[[src/target/linux_aarch64/gtk.rs:ST_APPLICATION]]
[[src/target/linux_aarch64/gtk.rs:LINE_BUF_CAP]]
...
exceed the bounds). [[src/target/linux_aarch64/gtk.rs:ST_TERM_AREA]]
[[src/target/linux_aarch64/gtk.rs:TERM_MAX_COLS]]
...
[[src/target/linux_aarch64/gtk.rs:ST_TERM_CHARS]]
[[src/target/linux_aarch64/gtk.rs:STATE_SIZE]]
...
`TERM_FONT_SIZE = "16"`. [[src/target/linux_aarch64/gtk.rs:COLOR_SET]]
...
keys, FALSE otherwise. [[src/target/linux_aarch64/gtk.rs:emit_key_pressed_handler]]
[[src/target/linux_aarch64/gtk.rs:MODE_RAW]]
...
`ST_TERM_CURSOR_VISIBLE`. [[src/target/linux_aarch64/gtk.rs:emit_term_draw_helper]]
...
- `_mfb_gtkapp_term_init` (main thread, at activate) measures the monospace cell
  ...
  blanks the char grid to spaces. [[src/target/linux_aarch64/gtk.rs:emit_term_init_helper]]
- `_mfb_gtkapp_term_write(string, newline)` is the worker-side grid writer the io
  ...
  [[src/target/linux_aarch64/gtk.rs:emit_term_write_helper]]
- `_mfb_gtkapp_term_scroll` shifts each grid up one row (memmove) and blanks the
  last (memset). [[src/target/linux_aarch64/gtk.rs:emit_term_scroll_helper]]
- The `term_show_idle` / `term_hide_idle` / `term_redraw_idle` callbacks (each
  ...
  [[src/target/linux_aarch64/gtk.rs:emit_term_show_idle_helper]]
...
run on the worker thread). [[src/target/linux_aarch64/gtk.rs:emit_app_term_helper]]
[[src/target/linux_aarch64/gtk.rs:ARENA_REG]]
...
> [[src/target/linux_aarch64/gtk.rs:emit_app_term_terminal_size]]
...
[[src/target/linux_aarch64/gtk.rs:emit_app_io_write_helper]]
...
[[src/target/linux_aarch64/gtk.rs:emit_app_io_input_helper]]
[[src/target/linux_aarch64/gtk.rs:emit_set_raw_input_mode]]
...
- **`finish` hard-exits.** `_mfb_gtkapp_finish` takes the exit code in `x0`; with
  ...
  [[src/target/linux_aarch64/gtk.rs:emit_finish_helper]]
...
[[src/target/linux_aarch64/gtk.rs:STR_STDERR_PREFIX]]
...
artifact debugging. [[src/target/linux_aarch64/gtk.rs:lib_for]]
