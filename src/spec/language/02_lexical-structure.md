...
- **Identifiers**: `[A-Za-z_][A-Za-z0-9_]*`, ASCII only (`is_ascii_alphanumeric() || '_'`). Legacy sigils (`$ % # !`) are removed. There is no length limit.
