use crate::bytecode::{
    BuiltinCallLowerer, ValueSlot, OPCODE_IO_FLUSH, OPCODE_IO_IS_TERMINAL, OPCODE_IO_POLL_INPUT,
    OPCODE_IO_READ_BYTE, OPCODE_IO_READ_CHAR, OPCODE_IO_READ_LINE, OPCODE_IO_TERMINAL_SIZE,
