...
impl CodeBuilder<'_> {
    ...
    pub(crate) fn emit_write_cursor_assert(
        &mut self,
    ...
    pub(crate) fn emit_build_error_loc(&mut self) -> Result<VirtualRegister, String> {
    ...
    pub(crate) fn emit_build_error_inline(
        &mut self,
        code_slot: usize,
        message_slot: usize,
        source_slot: usize,
    ...
    pub(crate) fn emit_finalize_worker_error_source(&mut self) -> Result<(), String> {
    ...
    pub(crate) fn emit_stamp_current_error_source(&mut self) -> Result<(), String> {
    ...
    pub(crate) fn emit_error_register_return(
        &mut self,
    ...
    pub(crate) fn ensure_pending_result_slots(&mut self) -> PendingResultSlots {
    ...
    pub(crate) fn store_pending_success_result(
        &mut self,
    ...
    pub(crate) fn current_error_slot_address(&mut self) -> VirtualRegister {
    ...
    pub(crate) fn emit_store_current_error(&mut self, base_register: impl Into<Operand>) {
    ...
    pub(crate) fn emit_adopt_current_error_block(&mut self) -> VirtualRegister {
        let addr = self.current_error_slot_address();
    ...
    pub(crate) fn emit_park_error_block_from_registers(&mut self) -> Result<(), String> {
    ...
    pub(crate) fn emit_free_error_block_from_slot(
        &mut self,
        ptr_slot: usize,
    ) -> Result<(), String> {
    ...
    pub(crate) fn store_pending_error_registers(
        &mut self,
        code_register: impl Into<Operand>,
    ...
    pub(crate) fn emit_load_error_fields(
        &mut self,
    ...
    pub(crate) fn store_pending_error_from_value(
        &mut self,
        error: &NirValue,
    ) -> Result<(), String> {
    ...
    pub(crate) fn emit_direct_error_return(&mut self, error: &NirValue) -> Result<(), String> {
    ...
    pub(crate) fn emit_direct_error_route_to_trap(
        &mut self,
        error: &NirValue,
    ) -> Result<(), String> {
        let error = self.lower_value(error)?;
    ...
    pub(crate) fn store_pending_current_result(&mut self) {
        let slots = self.ensure_pending_result_slots();
        self.emit(abi::store_u64(
            RESULT_VALUE_REGISTER,
            abi::stack_pointer(),
    ...
    pub(crate) fn load_pending_result_registers(&mut self) {
        let slots = self
    ...
    pub(crate) fn error_exit_destination(&self) -> ExitDestination {
