...
pub(crate) fn lower_signal_handler(platform: &dyn CodegenPlatform) -> Result<CodeFunction, String> {
...
/// tag check.
pub(crate) fn lower_closure_descriptor_initializer(func_symbols: &[String]) -> CodeFunction {
