...
pub(crate) fn stdin_log_data_object() -> CodeDataObject {
    CodeDataObject {
...
fn emit_libc(ctx: &mut EmitCtx, name: &str) -> Result<(), String> {
...
/// takes no lock.
pub(crate) fn lower_stdin_next_byte(
...
pub(crate) fn lower_stdin_recompute_base(
    platform_imports: &HashMap<String, String>,
    platform: &dyn CodegenPlatform,
) -> Result<CodeFunction, String> {
...
pub(crate) fn lower_stdin_subscribe(
    platform_imports: &HashMap<String, String>,
    platform: &dyn CodegenPlatform,
) -> Result<CodeFunction, String> {
...
pub(crate) fn lower_stdin_unsubscribe(
    platform_imports: &HashMap<String, String>,
    platform: &dyn CodegenPlatform,
) -> Result<CodeFunction, String> {
