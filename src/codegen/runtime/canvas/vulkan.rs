...
use crate::codegen::runtime::canvas::{
    ...
    HEADER_AUX0, HEADER_AUX1, HEADER_BLEND, HEADER_BOUNDS, HEADER_CAP, HEADER_CLIP_X0,
    HEADER_CLIP_X1, HEADER_CLIP_Y0, HEADER_CLIP_Y1, HEADER_FILL_R, HEADER_HAS_TRANSFORM,
