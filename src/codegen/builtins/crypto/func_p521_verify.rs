//! `crypto::p521Verify` — descriptor entry + authored docs.
//!
...
const INTRO: &str = r#"Verify an ECDSA P-521/SHA-512 signature against a public key (FIPS 186)."#;
const DESC: &str = r#"`crypto::p521Verify` checks whether `signature` is a valid ECDSA signature of
...
const EX: &str = r#"Verify a signature produced by `p521Sign`:
    ...
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![Implementation {
            params: vec![
                Parameter {
                    name: "publicKey",
                    desc: "The P-521 public key bytes.",
                    aliases: &[],
                    ty: bytes(),
