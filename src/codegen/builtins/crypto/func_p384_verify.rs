//! `crypto::p384Verify` — descriptor entry + authored docs.
//!
//! A NATIVE member: ECDSA verification on the NIST P-384 curve. Its `Body::native`
...
const EX: &str = r#"Verify a signature produced by `p384Sign`:
    ...
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![Implementation {
            params: vec![
                Parameter {
                    name: "publicKey",
                    desc: "The P-384 public key bytes.",
                    aliases: &[],
                    ty: bytes(),
