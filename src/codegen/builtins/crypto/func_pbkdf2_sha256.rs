//! `crypto::pbkdf2Sha256` — descriptor entry + authored docs.
//!
...
const EX: &str = r#"Derive a 32-byte key from a password string:
    ...
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![
            Implementation {
                ...
                body: Body::Rewrite("__crypto_pbkdf2Sha256_bytes"),
            },
            Implementation {
                params: vec![
                    Parameter {
                ...
                return_type: bytes(),
                errors: vec!["ErrInvalidArgument"],
                body: Body::Rewrite("__crypto_pbkdf2Sha256_text"),
            },
        ],
    });
}
