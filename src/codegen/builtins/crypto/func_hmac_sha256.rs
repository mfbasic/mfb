//! `crypto::hmacSha256` — descriptor entry + authored docs.
//!
...
const DESC: &str = r#"`crypto::hmacSha256` computes the keyed-hash message authentication code of
    ...
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![
            Implementation {
                ...
                return_type: bytes(),
                errors: vec![],
                body: Body::Rewrite("__crypto_hmacSha256_bytes"),
            },
            Implementation {
                params: vec![
                    Parameter {
                ...
                return_type: bytes(),
                errors: vec![],
                body: Body::Rewrite("__crypto_hmacSha256_text"),
            },
        ],
    });
}
