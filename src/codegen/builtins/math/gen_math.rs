...
impl CodeBuilder<'_> {
    ...
    pub(crate) fn emit_float_exponent_classify(
        &mut self,
    ...
    fn lower_math_rand(&mut self, args: &[NirValue]) -> Result<ValueResult, String> {
        ...
        self.emit(abi::multiply_subtract_registers(
            &threshold, &quotient, &range_reg, &neg_span,
        ));
        self.emit(abi::store_u64(
            &threshold,
            abi::stack_pointer(),
    ...
    pub(crate) fn emit_float_result_check(
        &mut self,
        bits: impl Into<Operand>,
    ...
    pub(crate) fn emit_float_result_check_fp(
        &mut self,
    ...
    pub(crate) fn observe_promoted_float(
        &mut self,
        value: &NirValue,
        d: &str,
    ) -> Result<(), String> {
