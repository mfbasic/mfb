...
quadrant. On the negative x-axis the sign of `y` still counts: `atan2(0.0, -1.0)`
is `pi`, and a `y` of `-0.0` gives `-pi`. Both arguments must be the same type (`Float` or `Fixed`), echoing that
