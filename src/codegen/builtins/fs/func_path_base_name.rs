...
//! site through the `Body::abi_inline_self` (self-lowering) (`gen_path_builder::lower_fs_path_base_name_nl`).

use super::gen_path_builder::lower_fs_path_base_name_nl;
...
pub(crate) fn register(pkg: &mut RegistryPackage) {
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![Implementation {
            ...
            errors: vec![],
            body: Body::abi_inline_self(lower_fs_path_base_name_nl),
        }],
    });
}
