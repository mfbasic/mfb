...
//!
//! Descriptor + docs migrated from `src/docs/man/builtins/bits/rl32.md`; lowering
...
pub(super) fn register(pkg: &mut RegistryPackage) {
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![Implementation {
            ...
            errors: vec![],
            body: Body::native(None, None, Some(lower_bits_rl32)),
        }],
    });
}
...
pub(crate) fn lower_bits_rl32(
    ...
    let (value_reg, count_reg, value_text, count_text) =
        super::gen_two_integers::lower_bits_two_integers(builder, "rl32", args)?;
