...
impl CodeBuilder<'_> {
    ...
    pub(crate) fn lower_strings_to_bytes(
        &mut self,
        value: &NirValue,
    ) -> Result<ValueResult, String> {
        let scratch16 = self.temporary_vreg();
    ...
    pub(crate) fn lower_strings_case_map(
        ...
        let ascii_transform_loop = self.label("strings_case_map_ascii_transform_loop");
        let ascii_transform_done = self.label("strings_case_map_ascii_transform_done");
        let case_slow = self.label("strings_case_map_slow");
        let case_done = self.label("strings_case_map_done");
        ...
        self.emit(abi::label(&ascii_transform));
        self.emit_checked_size_add_immediate(
            abi::return_register(),
            &scratch21,
            9,
        ...
        self.emit(abi::compare_registers(&scratch23, &scratch21));
        self.emit(abi::branch_ge(&ascii_transform_done));
        self.emit(abi::add_registers(&scratch14, &scratch22, &scratch23));
        self.emit(abi::load_u8(&scratch10, &scratch14, 0));
        ...
        self.emit(abi::add_immediate(&scratch23, &scratch23, 1));
        self.emit(abi::branch(&ascii_transform_loop));
        self.emit(abi::label(&ascii_transform_done));
        self.emit(abi::move_immediate(&scratch10, "Integer", "0"));
        self.emit(abi::store_u8(&scratch10, &scratch28, 0));
        self.emit(abi::branch(&case_done));

        self.emit(abi::label(&case_slow));
        self.emit(abi::load_u64(&scratch20, abi::stack_pointer(), value_slot));
        self.emit(abi::load_u64(&scratch21, &scratch20, 0));
        self.emit(abi::add_immediate(&scratch22, &scratch20, 8));
        self.emit(abi::move_immediate(&scratch23, "Integer", "0"));
    ...
    pub(crate) fn lower_strings_normalize_nfc(
        &mut self,
        value: &NirValue,
    ) -> Result<ValueResult, String> {
        let scratch20 = self.temporary_vreg();
    ...
    pub(crate) fn lower_strings_byte_len(
        &mut self,
        value: &NirValue,
    ) -> Result<ValueResult, String> {
        let value = self.lower_value(value)?;
    ...
    pub(crate) fn lower_strings_starts_with(
        &mut self,
        value: &NirValue,
        prefix: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_ends_with(
        &mut self,
        value: &NirValue,
        suffix: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_contains(
        &mut self,
        value: &NirValue,
        needle: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_join(
        &mut self,
        parts: &NirValue,
        delimiter: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_split(
        &mut self,
        value: &NirValue,
        delimiter: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_count(
        &mut self,
        value: &NirValue,
        needle: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    /// error 77050002.
    pub(crate) fn lower_strings_repeat(
        &mut self,
        value: &NirValue,
        times: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_graphemes_count(
        &mut self,
        value: &NirValue,
    ) -> Result<ValueResult, String> {
        let scratch16 = self.temporary_vreg();
    ...
    pub(crate) fn lower_strings_display_width(
        &mut self,
        value: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_grapheme_at(
        &mut self,
        value: &NirValue,
        index: &NirValue,
    ) -> Result<ValueResult, String> {
    ...
    pub(crate) fn lower_strings_trim_chars(
        &mut self,
        value: &NirValue,
        chars: &NirValue,
    ) -> Result<ValueResult, String> {
