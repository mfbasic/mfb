...
const INTRO: &str = r#"Concatenate a list of strings, inserting a delimiter between elements."#;

const DESC: &str = r#"`strings::join` walks `parts` from first to last and concatenates the elements
    ...
    pkg.add_function(RegistryFunction {
        ...
        implementations: vec![Implementation {
            params: vec![
                Parameter {
                    name: "parts",
                    desc: "The strings to concatenate, in order. Any list is accepted, including the empty list and lists containing empty strings. Also accepted under the name `values`.",
                    aliases: &["values"],
                ...
                Parameter {
                    name: "delimiter",
                    desc: "The separator placed between successive elements. Any `String`, including the empty one. Also accepted under the name `separator`.",
                    aliases: &["separator"],
