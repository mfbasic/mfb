...
impl CodeInstruction {
    ...
    pub(crate) fn validate(&self) -> Result<(), String> {
        let required: &[&str] = match self.op {
            ...
            CodeOp::LdarU64 | CodeOp::LdarU32 => &["dst", "base"],
            CodeOp::StlrU64 => &["src", "base"],
...
pub(crate) fn join_json<T: ToCodeJson>(values: &[T], indent: usize) -> String {
    values
        .iter()
