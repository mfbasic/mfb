...
pub(super) fn emit_append_helper() -> CodeFunction {
    ...
    asm.push(abi::move_register(abi::LOCAL[0], "x0")); // text view
    asm.push(abi::move_register(abi::LOCAL[1], "x1")); // nsstring
    ...
    asm.push(abi::move_register("x0", abi::LOCAL[2]));
    asm.call_external("_objc_msgSend", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[2], "x0")); // fixed-pitch font
    ...
    asm.push(abi::move_register("x2", abi::LOCAL[2])); // object: font
    ...
    asm.call_external("_objc_msgSend", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[3], "x0")); // attributes dictionary
    ...
    asm.push(abi::move_register("x0", abi::LOCAL[2]));
    asm.call_external("_objc_msgSend", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[2], "x0")); // allocated attributed string
    asm.load_selector(SEL_INIT_WITH_STRING_ATTRS.0);
    asm.push(abi::move_register("x2", abi::LOCAL[1])); // string
    asm.push(abi::move_register("x3", abi::LOCAL[3])); // attributes
    asm.push(abi::move_register("x0", abi::LOCAL[2]));
    asm.call_external("_objc_msgSend", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[1], "x0")); // attributed string

    // storage = [textView textStorage]
    asm.load_selector(SEL_TEXT_STORAGE.0);
    asm.push(abi::move_register("x0", abi::LOCAL[0]));
    asm.call_external("_objc_msgSend", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[0], "x0")); // text storage
    ...
    asm.push(abi::move_register(abi::LOCAL[2], "x1")); // appendAttributedString: SEL
    asm.load_selector(SEL_PERFORM_ON_MAIN.0);
    asm.push(abi::move_register("x2", abi::LOCAL[2]));
    asm.push(abi::move_register("x3", abi::LOCAL[1]));
    asm.push(abi::move_immediate("x4", "Integer", "1")); // waitUntilDone YES
    asm.push(abi::move_register("x0", abi::LOCAL[0])); // receiver: text storage
    asm.call_external("_objc_msgSend", LIB_OBJC);
    ...
    asm.push(abi::move_register("x0", abi::LOCAL[1])); // attributed string
    asm.call_external("_objc_msgSend", LIB_OBJC);
...
pub(super) fn emit_finish_helper(uses_term: bool) -> CodeFunction {
    ...
    asm.push(abi::move_register(abi::LOCAL[0], "x0")); // exit code
    ...
    asm.local_address("x1", ASSOC_KEY);
    asm.call_external("_objc_getAssociatedObject", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[2], "x0")); // transcript view or nil
    ...
    asm.push(abi::move_register("x0", abi::LOCAL[1]));
    asm.call_external("_objc_msgSend", LIB_OBJC);
    asm.push(abi::move_register(abi::LOCAL[1], "x0")); // allocated NSString
