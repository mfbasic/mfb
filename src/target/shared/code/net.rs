...
/// record layout.
pub(super) fn lower_net_bind_udp_helper(
    symbol: &str,
    platform_imports: &HashMap<String, String>,
    platform: &dyn CodegenPlatform,
) -> Result<(CodeFrame, Vec<CodeInstruction>, Vec<CodeRelocation>), String> {
...
pub(super) fn lower_net_receive_from_helper(
    symbol: &str,
    platform_imports: &HashMap<String, String>,
    platform: &dyn CodegenPlatform,
    text: bool,
    ...
    instructions.push(abi::store_u64("x1", abi::stack_pointer(), ADDRPTR_OFFSET));
    if text {
        // Build a String: [u64 len][bytes][nul], validate UTF-8.
        instructions.extend([
            abi::load_u64("x10", abi::stack_pointer(), N_OFFSET),
...
pub(super) fn lower_net_send_to_helper(
    symbol: &str,
    platform_imports: &HashMap<String, String>,
    platform: &dyn CodegenPlatform,
    text: bool,
