...
Terminal and standard-stream I/O (`IMPORT io`): `io::print`, `io::write`, `io::printError`, `io::writeError`, `io::flush`, `io::input`, `io::readLine`, `io::readChar`, `io::readByte`, `io::pollInput`, `io::isInputTerminal`, `io::isOutputTerminal`, `io::isErrorTerminal`. (`src/builtins/io.rs` `is_io_call`.)
