...
| `77050001` | `ErrIndexOutOfRange` | `start` is less than `0` or greater than the scalar length of `value`. [[src/codegen/builtins/regex/func_find.rs:__regex_find]] [[src/codegen/builtins/errorcode/mod.rs:ErrIndexOutOfRange]] |
