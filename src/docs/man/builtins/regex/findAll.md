...
| `77050001` | `ErrIndexOutOfRange` | `start` is less than `0` or greater than the scalar length of `value`. [[src/codegen/builtins/regex/func_find_all.rs:__regex_findAll]] [[src/builtins/errorcode.rs:ErrIndexOutOfRange]] |
