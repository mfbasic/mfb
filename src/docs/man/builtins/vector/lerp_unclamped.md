...
| `77050015` | `ErrFloatOverflow` | On the `Float` overloads, a difference or extrapolated component reaches infinity and is caught where it is bound. [[src/codegen/builtins/errorcode/mod.rs:ErrFloatOverflow]] |
