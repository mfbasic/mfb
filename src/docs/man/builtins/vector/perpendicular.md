...
[[src/codegen/builtins/vector/package.mfb:__vector_cross_float2]]
...
[[src/codegen/builtins/vector/package.mfb:__vector_perpendicular_integer2]]
...
| --- | --- | --- |
| `v` | `Float2`, `Fixed2`, or `Integer2` | The 2D vector to rotate a quarter turn counterclockwise. The zero vector is accepted and returns the zero vector. Also spelled `v` as a named argument. [[src/codegen/builtins/vector/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| the same type as `v` | The vector `(-v.y, v.x)`: orthogonal to `v`, the same magnitude as `v`, a quarter turn counterclockwise from it. The zero vector maps to the zero vector. [[src/codegen/builtins/vector/mod.rs:VECTOR]] |
