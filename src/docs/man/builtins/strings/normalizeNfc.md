...
| --- | --- | --- |
| `value` | `String` | The string to normalize. Any `String` is accepted, including the empty string. [[src/codegen/registry/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| `String` | A new `String` holding the NFC form of `value`. The empty string yields `""`; a string already in NFC yields an equal string. [[src/codegen/builtins/strings/mod.rs:register]] |
