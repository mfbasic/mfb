...
| --- | --- | --- |
| `value` | `String` | The string whose display width is measured. Any `String` is accepted, including the empty string. [[src/codegen/registry/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| `Integer` | The total number of terminal columns `value` occupies, a non-negative `Integer`. `0` for the empty string. [[src/codegen/builtins/strings/mod.rs:register]] |
