...
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `needle` is the empty string. [[src/target/shared/code/builder_strings_builtins.rs:lower_strings_count]] [[src/codegen/builtins/errorcode/mod.rs:ErrInvalidArgument]] |
