...
[[src/codegen/builtins/app/mod.rs:register]]
...
`app::setMode`. [[src/codegen/builtins/app/mod.rs:register]]
...
reading the current mode cannot fail. [[src/codegen/builtins/app/mod.rs:APP]]
