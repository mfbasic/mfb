...
[[src/codegen/builtins/money/mod.rs:Rounding]]
...
`money::getRounding` takes no parameters. [[src/codegen/builtins/money/mod.rs:MONEY]]

## Return value

| Type | Description |
| --- | --- |
| `Rounding` | The mode in effect on the calling thread: `Rounding.Commercial` (round half away from zero, the default) or `Rounding.Banker` (round half to even). [[src/codegen/builtins/money/mod.rs:MONEY]] |
