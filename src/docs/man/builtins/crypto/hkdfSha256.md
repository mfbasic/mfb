...
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `length` is less than 1 or greater than `8160` (`255 * 32`), the maximum output HKDF-Expand can produce for a 32-byte hash. [[src/builtins/crypto_hash.mfb:__crypto_hkdfSha256]] [[src/codegen/builtins/errorcode/mod.rs:ErrInvalidArgument]] |
