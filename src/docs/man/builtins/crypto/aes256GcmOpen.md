...
[[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]]
...
rejected. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]]
...
`ErrInvalidArgument`. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]]
...
defaults to the empty list when omitted. [[src/codegen/registry/mod.rs:default_argument_padding]]
...
the empty list. [[src/codegen/registry/mod.rs:default_argument_padding]]
...
or verification fails. [[src/codegen/registry/mod.rs:call_param_names]]

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| `key` | `List OF Byte` | The 256-bit AES key. Must be exactly 32 bytes and identical to the sealing key. This value is secret. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]] |
| `nonce` | `List OF Byte` | The 96-bit GCM nonce. Must be exactly 12 bytes and identical to the nonce used to seal the message. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]] |
...
| `aad` | `List OF Byte` | Optional additional authenticated data. Must be identical to the `aad` passed when sealing. Defaults to the empty list. [[src/codegen/registry/mod.rs:default_argument_padding]] |

## Return value

| Type | Description |
| --- | --- |
| `List OF Byte` | The recovered plaintext, the same length as the original message, returned only when the tag verifies. An empty message recovers an empty list. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77050016` | `ErrAuthenticationFailed` | The authentication tag does not verify — the `ciphertext`, `tag`, `nonce`, or `aad` was altered or does not belong to this key. No plaintext is returned. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]] [[src/target/shared/code/error_constants.rs:176]] |
| `77050002` | `ErrInvalidArgument` | `key` is not exactly 32 bytes, or `nonce` is not exactly 12 bytes. [[src/codegen/builtins/crypto/package.mfb:__crypto_aes256GcmOpen]] [[src/codegen/builtins/errorcode/mod.rs:ErrInvalidArgument]] |
