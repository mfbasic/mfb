...
outer passes. [[src/codegen/builtins/crypto/package.mfb:__crypto_hmacSha256_bytes]]
...
| Type | Description |
| --- | --- |
| `List OF Byte` | The 32-byte HMAC-SHA-256 code of `data` under `key`. Always exactly 32 bytes regardless of input length. [[src/codegen/builtins/crypto/mod.rs:CRYPTO]] |
