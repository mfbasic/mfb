...
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `privateKey` is not exactly 97 bytes (the P-256 point length plus field length). [[src/target/shared/code/crypto_ec/openssl.rs:sign]] |
