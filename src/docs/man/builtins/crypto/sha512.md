...
| Type | Description |
| --- | --- |
| `List OF Byte` | The 64-byte SHA-512 digest of `data`. Always exactly 64 bytes regardless of input length. [[src/builtins/crypto.rs:CRYPTO]] [[src/builtins/crypto_hash.mfb:__crypto_sha512_bytes]] |
