...
length. [[src/builtins/crypto_hash.mfb:__crypto_sha512_bytes]] [[src/builtins/crypto_hash.mfb:__crypto_sha2_64]]
...
| Type | Description |
| --- | --- |
| `List OF Byte` | The 64-byte SHA-512 digest of `data`. Always exactly 64 bytes regardless of input length. [[src/builtins/crypto.rs:call_return_type_name]] [[src/builtins/crypto_hash.mfb:__crypto_sha512_bytes]] |
