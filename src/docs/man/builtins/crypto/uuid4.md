...
splits the digits into the five hyphenated groups. [[src/codegen/builtins/crypto/package.mfb:__crypto_uuid4]]
...
[[src/codegen/builtins/crypto/native/random.rs:lower_crypto_random_bytes_helper]] As with all
...
| --- | --- | --- |
| — | — | `uuid4` takes no parameters. [[src/codegen/builtins/crypto/mod.rs:CRYPTO]] |

## Return value

| Type | Description |
| --- | --- |
| `String` | A canonical lowercase 8-4-4-4-12 version-4 UUID, 36 characters including the four hyphens. [[src/codegen/builtins/crypto/mod.rs:CRYPTO]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77050000` | `ErrUnknown` | The OS entropy call (`getentropy`) backing the internal `crypto::randomBytes(16)` draw fails. [[src/codegen/builtins/crypto/native/random.rs:lower_crypto_random_bytes_helper]] |
| `77010001` | `ErrOutOfMemory` | An arena allocation for the random bytes or the assembled UUID `String` fails. [[src/codegen/builtins/errorcode/mod.rs:ErrOutOfMemory]] |
