...
| Type | Description |
| --- | --- |
| `List OF Byte` | The ASN.1 DER (X9.62) `Ecdsa-Sig-Value` ECDSA signature. Variable length (roughly 102–104 bytes) depending on the encoding of the `r` and `s` integers. [[src/builtins/crypto.rs:CRYPTO]] |
