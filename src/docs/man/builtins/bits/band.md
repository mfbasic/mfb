...
| Type | Description |
| --- | --- |
| `Integer` | The bitwise AND of `a` and `b`. `0` when the operands share no set bits; equal to either operand when it is a subset of the other. [[src/codegen/builtins/bits/mod.rs:register]] |
