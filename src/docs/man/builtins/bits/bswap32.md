...
| --- | --- | --- |
| `value` | `Integer` | The value whose low 32 bits are byte-reversed. Bits above bit `31` are ignored and do not appear in the result. [[src/codegen/registry/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| `Integer` | The byte-reversed low 32 bits of `value`, with bits `32`..`63` cleared to zero. Always in the range `0`..`4294967295`. [[src/codegen/builtins/bits/mod.rs:register]] |
