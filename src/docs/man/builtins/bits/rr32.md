...
| Type | Description |
| --- | --- |
| `Integer` | The low 32 bits of `value` rotated right by `count MOD 32`, zero-extended into bits 32..63. Equal to the low 32 bits of `value` when `count` is a multiple of 32. [[src/builtins/bits.rs:BITS]] |
