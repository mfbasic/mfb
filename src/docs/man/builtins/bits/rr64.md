...
the result is forced to zero. [[src/codegen/builtins/bits/native.rs:lower_bits_rotate]]
...
execution paths.
[[src/codegen/builtins/bits/native.rs:lower_bits_rotate]] [[src/target/shared/abi.rs:rotate_right_registers]]
...
| `count` | `Integer` | The number of bit positions to rotate right, reduced modulo 64. Any value, including negative counts, is accepted. [[src/codegen/builtins/bits/native.rs:lower_bits_rotate]] |
