...
the result is forced to zero. [[src/codegen/builtins/bits/func_rl64.rs:lower_bits_rl64]]
...
[[src/codegen/builtins/bits/func_rl64.rs:lower_bits_rl64]]
...
execution paths. [[src/codegen/builtins/bits/func_rl64.rs:lower_bits_rl64]]
...
| `count` | `Integer` | The number of bit positions to rotate left, reduced modulo 64. Any value, including negative counts, is accepted. [[src/codegen/builtins/bits/func_rl64.rs:lower_bits_rl64]] |

## Return value

| Type | Description |
| --- | --- |
| `Integer` | All 64 bits of `value` rotated left by `count MOD 64`. Equal to `value` when `count` is a multiple of 64. [[src/codegen/builtins/bits/mod.rs:register]] |
