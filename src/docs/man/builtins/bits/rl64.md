...
| `count` | `Integer` | The number of bit positions to rotate left, reduced modulo 64. Any value, including negative counts, is accepted. [[src/codegen/builtins/bits/native.rs:lower_bits_rotate]] |
