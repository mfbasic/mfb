...
[[src/codegen/builtins/collections/func_is_disjoint.rs:__collections_isDisjoint]]
...
| --- | --- | --- |
| `a` | `Set OF T` | The first set, walked element by element. Not modified. `T` must be a comparable type. [[src/codegen/builtins/collections/func_is_disjoint.rs:__collections_isDisjoint]] |
| `b` | `Set OF T` | The second set, of the same type as `a`, tested for shared membership. Not modified. [[src/codegen/builtins/collections/func_is_disjoint.rs:__collections_isDisjoint]] |

## Return value

| Type | Description |
| --- | --- |
| `Boolean` | `TRUE` when `a` and `b` share no element (including when either is empty); `FALSE` when they share at least one element. [[src/codegen/builtins/collections/func_is_disjoint.rs:__collections_isDisjoint]] |
...
rejected at compile time. [[src/codegen/builtins/collections/func_is_disjoint.rs:__collections_isDisjoint]]
