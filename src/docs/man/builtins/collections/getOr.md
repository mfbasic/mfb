...
| Type | Description |
| --- | --- |
| `T` (list overload) or `V` (map overload) | The selected element when it exists, otherwise `default`. Owned by the caller on both paths. [[src/codegen/registry/mod.rs:resolve_call]] |
