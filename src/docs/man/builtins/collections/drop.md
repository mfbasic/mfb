...
| Type | Description |
| --- | --- |
| `List OF T` | A new list of the last `len(value) - min(max(count, 0), len(value))` elements of `value`, in their original order. [[src/codegen/builtins/collections/common/slice.rs:lower_list_slice_range]] |
