...
[[src/codegen/builtins/collections/collections_package.mfb:__collections_drop]]
...
`[start, len]`. [[src/codegen/builtins/collections/collections_package.mfb:__collections_drop]]
...
| --- | --- | --- |
| `value` | `List OF T` | The source list. Any length is accepted, including the empty list. Named-argument spelling is `value`. [[src/codegen/builtins/collections/collections_package.mfb:__collections_drop]] |
| `count` | `Integer` | How many leading elements to discard. Any `Integer` is accepted: values at or below 0 return the whole list and values at or above the length return the empty list. Named-argument spelling is `count`. [[src/codegen/builtins/collections/collections_package.mfb:__collections_drop]] |
