...
| Type | Description |
| --- | --- |
| `List OF V` | A new owned list of the map's values, one per entry, in the map's entry order; the empty list for an empty map. May contain duplicates. [[src/codegen/registry/mod.rs:resolve_call]] |
