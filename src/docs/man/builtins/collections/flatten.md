...
element. [[src/codegen/builtins/collections/func_flatten.rs:__collections_flatten]] [[src/codegen/builtins/collections/mod.rs:resolve_append]]
...
[[src/codegen/builtins/collections/func_flatten.rs:__collections_flatten]]
...
| --- | --- | --- |
| `value` | `List OF List OF T` | The list of inner lists to concatenate. May be empty, and any inner list may be empty. Not modified. [[src/codegen/builtins/collections/func_flatten.rs:__collections_flatten]] |

## Return value

| Type | Description |
| --- | --- |
| `List OF T` | A new list holding every item of every inner list of `value`, inner lists in order and items within each inner list in order. Empty when `value` is empty or when every inner list is empty. [[src/codegen/builtins/collections/func_flatten.rs:__collections_flatten]] |
...
outermost level. [[src/codegen/builtins/collections/func_flatten.rs:__collections_flatten]]
