...
user-supplied comparison and no key-extraction overload. [[src/codegen/builtins/collections/package.mfb:__collections_distinct]] [[src/codegen/registry/mod.rs:resolve_call]]
