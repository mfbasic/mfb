...
| Type | Description |
| --- | --- |
| `Fixed` | The `Fixed` nearest to `ln(10)`, approximately `2.302585092994046`. The same value on every reference. [[src/codegen/builtins/math/mod.rs:constant_value]] |
