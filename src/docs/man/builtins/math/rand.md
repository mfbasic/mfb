...
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `min` is greater than `max`, so the requested range is empty. Checked before any draw is taken. [[src/codegen/builtins/errorcode/mod.rs:ErrInvalidArgument]] [[src/target/shared/code/builder_math.rs:lower_math_rand]] |
