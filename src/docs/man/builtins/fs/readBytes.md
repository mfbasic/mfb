...
text. [[src/codegen/builtins/fs/native/atomic.rs:lower_fs_read_bytes_path_helper]]
...
[[src/codegen/builtins/fs/native/io.rs:lower_fs_read_all_bytes_helper]]
...
[[src/codegen/builtins/fs/native/atomic.rs:lower_fs_read_bytes_path_helper]]
...
| Type | Description |
| --- | --- |
| `List OF Byte` | The complete contents of the file as a `List OF Byte`, in file order. An empty file returns an empty list. [[src/codegen/builtins/fs/mod.rs:register]] |
...
| `77020001` | `ErrRead` | Determining the file's length or reading its bytes fails partway through, before the full contents have been read. [[src/codegen/builtins/fs/native/io.rs:lower_fs_read_all_bytes_helper]] |
