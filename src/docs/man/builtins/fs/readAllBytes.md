...
[[src/target/shared/code/fs/io.rs:emit_reconcile_read_buffer]]
...
| --- | --- | --- |
| `77030004` | `ErrResourceClosed` | `file` has already been closed. [[src/target/shared/code/fs/io.rs:lower_fs_read_all_bytes_helper]] |
