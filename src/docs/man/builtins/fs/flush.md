...
[[src/target/shared/code/fs_helpers_io.rs:lower_fs_flush_helper]]
...
[[src/target/shared/code/fs_helpers_io.rs:lower_fs_file_drain]]
...
| --- | --- | --- |
| `77020002` | `ErrOutput` | The underlying write of the buffered bytes fails — for example the disk is full or the descriptor is no longer writable. The buffer is left intact so the flush can be retried. [[src/target/shared/code/fs_helpers_io.rs:lower_fs_flush_helper]] |
