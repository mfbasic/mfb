...
[[src/target/shared/code/fs_helpers_atomic.rs:emit_uuid_v4_to_path]]
...
[[src/target/shared/code/fs_helpers_atomic.rs:temp_file_open_flags]]
...
[[src/target/shared/code/fs_helpers_atomic.rs:lower_fs_create_temp_file_helper]]
...
| `77050004` | `ErrNotFound` | The file cannot be created because a path component does not exist, such as a missing containing directory (host `ENOENT`). [[src/target/shared/code/fs_helpers.rs:emit_errno_error_mapping]] |
| `77030003` | `ErrAccessDenied` | The host denies permission to create the file in the directory (host `EACCES`). [[src/target/shared/code/fs_helpers.rs:emit_errno_error_mapping]] |
| `77050005` | `ErrAlreadyExists` | Exclusive creation fails because a file with the generated name already exists (host `EEXIST`). [[src/target/shared/code/fs_helpers.rs:emit_errno_error_mapping]] |
| `77020002` | `ErrOutput` | Random bytes for the name cannot be obtained, or the host refuses to create the file for any other reason not classified above. [[src/target/shared/code/fs_helpers.rs:emit_errno_error_mapping]] |
