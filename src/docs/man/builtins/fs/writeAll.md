...
| `77020002` | `ErrOutput` | `file` was not opened for writing, or the host write fails partway through before all of `value` has been written. [[src/builtins/errorcode.rs:ErrWriteFailed]] |
