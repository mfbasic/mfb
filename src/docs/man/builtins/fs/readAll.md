...
[[src/target/shared/code/fs_helpers_io.rs:lower_fs_read_all_helper]]
...
`fs::readText`. [[src/target/shared/code/fs_helpers_io.rs:emit_reconcile_read_buffer]]
...
| Type | Description |
| --- | --- |
| `String` | The remaining contents of `file`, from the current position to end of input, in file order, as a UTF-8 `String`. When `file` is already at end of input, an empty `String` is returned. [[src/target/shared/code/fs_helpers_io.rs:lower_fs_read_all_helper]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77030004` | `ErrResourceClosed` | `file` has already been closed. [[src/target/shared/code/fs_helpers_io.rs:lower_fs_read_all_helper]] |
