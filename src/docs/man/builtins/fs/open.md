...
(audit-2 OS-01 / bug-184). [[src/target/shared/code/fs/io.rs:open_flag_set]]
...
| `77030003` | `ErrAccessDenied` | The host denies access to `path` for the requested mode (host `EACCES`). [[src/target/shared/code/fs/mod.rs:emit_fs_path_errno_error_mapping]] |
