...
default and must be supplied explicitly. [[src/codegen/builtins/fs/mod.rs:register]]
...
(audit-2 OS-01 / bug-184). [[src/codegen/builtins/fs/native/io.rs:open_flag_set]]
