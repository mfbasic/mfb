...
| --- | --- | --- |
| `77010001` | `ErrOutOfMemory` | The `List OF Byte` holding the encoded bytes cannot be allocated. [[src/codegen/builtins/errorcode/mod.rs:ErrOutOfMemory]] [[src/target/shared/code/builder_strings_builtins.rs:lower_strings_to_bytes]] |
