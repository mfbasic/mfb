...
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `method` is empty or contains a space, or a caller header name/value or the URL-derived request target/`Host` contains a control byte (below `0x20`). [[src/target/shared/code/error_constants.rs:ERR_INVALID_ARGUMENT_CODE]] |
