...
raises an error, and closing twice is a no-op. [[src/codegen/builtins/audio/mod.rs:CLOSE_INPUT]]
...
be worse than no field. [[src/codegen/builtins/audio/native/macos.rs:SEL_UID]] [[src/codegen/builtins/audio/native/mod.rs]]
...
A description of one audio device, obtained only from `audio::devices()`. [[src/codegen/builtins/audio/mod.rs:register]]
...
value record: construct it with `AudioEnvelope[...]`. [[src/codegen/builtins/audio/mod.rs:AudioEnvelope]] [[src/codegen/builtins/audio/mod.rs:register]]
...
record; construct it with `AudioNote[...]`. [[src/codegen/builtins/audio/mod.rs:AudioNote]] [[src/codegen/builtins/audio/mod.rs:register]]

| Field | Type | Description |
| --- | --- | --- |
| `frequencyHz` | `Float` | Sine frequency in hertz. |
| `noteFrames` | `Integer` | Total length in frames (one frame is 2 bytes of mono s16le at 48 kHz). [[src/codegen/builtins/audio/package.mfb:__audio_render]] |
