...
zero or negative. [[src/codegen/builtins/datetime/func_date.rs:__datetime_date]]
...
[[src/codegen/builtins/datetime/func_date.rs:__datetime_date]]
...
| `month` | `Integer` | The month of the year. Must be in `1 .. 12`, where `1` is January and `12` is December. Any value outside this range is an error. [[src/codegen/builtins/datetime/func_date.rs:__datetime_date]] |
| `day` | `Integer` | The day of the month. Must be in `1 .. N`, where `N` is the number of days in the given month and year (28, 29, 30, or 31). Any value outside this range is an error. [[src/codegen/builtins/datetime/func_date.rs:__datetime_date]] |
