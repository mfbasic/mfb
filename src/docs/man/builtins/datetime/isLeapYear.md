...
| Type | Description |
| --- | --- |
| `Boolean` | `True` when `year` is a leap year (366 days, with a 29-day February) under the proleptic-Gregorian rule, and `False` otherwise. [[src/codegen/builtins/datetime/mod.rs:DATETIME]] |
