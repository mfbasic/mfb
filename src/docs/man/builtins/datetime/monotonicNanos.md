...
nanoseconds. [[src/codegen/builtins/datetime/mod.rs:DATETIME]]
...
constructing a `Duration`. [[src/codegen/builtins/datetime/native.rs:lower_datetime_helper]]
...
| --- | --- | --- |
| — | — | `datetime::monotonicNanos` takes no arguments. [[src/codegen/builtins/datetime/mod.rs:DATETIME]] |
