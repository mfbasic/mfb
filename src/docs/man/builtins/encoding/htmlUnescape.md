...
and `;`: [[src/codegen/builtins/encoding/mod.rs:__encoding_htmlUnescape]]
...
| Type | Description |
| --- | --- |
| `String` | A copy of `text` with each named and numeric character reference replaced by its character. The empty string for empty input. [[src/codegen/builtins/encoding/mod.rs:ENCODING]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77050003` | `ErrInvalidFormat` | A `&` reference is not closed by a `;`; a numeric reference has empty or non-digit digits; a named reference is unknown; or a numeric reference resolves to a value above `1114111`. [[src/codegen/builtins/encoding/mod.rs:__encoding_htmlUnescape]] [[src/codegen/builtins/encoding/package.mfb:__encoding_fromCodepoint]] [[src/builtins/errorcode.rs:ErrInvalidFormat]] |
