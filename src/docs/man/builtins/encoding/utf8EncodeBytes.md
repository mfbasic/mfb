...
`strings::toBytes(value)`. [[src/codegen/builtins/encoding/mod.rs:__encoding_utf8EncodeBytes]]
...
[[src/codegen/builtins/encoding/mod.rs:UTF8_ENCODE_BYTES]] [[src/codegen/builtins/encoding/mod.rs:resolve_overload_target]]
...
| --- | --- | --- |
| `value` | `String` | The text to encode. Any string, including the empty string, is accepted. [[src/codegen/builtins/encoding/mod.rs:__encoding_utf8EncodeBytes]] |
