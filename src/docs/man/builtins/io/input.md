...
| --- | --- | --- |
| `77020002` | `ErrOutput` | Writing the prompt to standard output fails. Only possible for a non-empty prompt. [[src/codegen/builtins/errorcode/mod.rs:ErrWriteFailed]] |
...
| `77020004` | `ErrEncoding` | The bytes read do not form a valid UTF-8 sequence. [[src/codegen/builtins/errorcode/mod.rs:ErrEncoding]] |
| `77020005` | `ErrInput` | Reading standard input fails for any other reason. [[src/codegen/builtins/errorcode/mod.rs:ErrInputFailed]] |
