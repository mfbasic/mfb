...
| `77020005` | `ErrInput` | The poll of standard input fails for a reason other than an interrupting signal, which is retried instead. [[src/codegen/builtins/errorcode/mod.rs:ErrInputFailed]] |
