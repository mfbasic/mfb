...
`term::showCursor` takes no parameters. [[src/codegen/registry/mod.rs:call_param_names]]

## Return value

| Type | Description |
| --- | --- |
| `Nothing` | Returns nothing. The call is made for its side effect of marking the cursor visible. [[src/codegen/builtins/term/mod.rs:register]] |
