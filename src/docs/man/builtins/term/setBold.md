...
disables it. [[src/codegen/builtins/term/mod.rs:register]] [[src/codegen/registry/mod.rs:argument_types]]
...
| --- | --- | --- |
| `enabled` | `Boolean` | `TRUE` to draw subsequent text bold, `FALSE` to draw it normally. [[src/codegen/registry/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| `Nothing` | Returns nothing. The call is made for its side effect of setting the current bold attribute. [[src/codegen/builtins/term/mod.rs:register]] |
