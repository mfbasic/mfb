...
Status: Open — Phase 0 + 16 splits landed (Tier 1: T1-1, T1-2, T1-3, T1-4, T1-7,
...
- [x] T2-4 `code/fs/` directory created
...
- [x] T2-3 `builder_codegen_primitives.rs` → 6 modules (commit)
- [x] T2-8 `io_helpers.rs` → 3 modules (commit)
- [x] T2-2 `builder_collection_mutate.rs` → 4 modules (commit)
- [x] T2-4 `code/fs/` directory created (commit)
- [x] T2-5 `code/os/` directory (commit)
- [x] T2-10 `cli/build/` directory (commit)
- [x] T2-7 `shared/validate/` directory (commit; constfold dedup left to Agent 09 #1)
- [ ] glob→explicit conversion remains
