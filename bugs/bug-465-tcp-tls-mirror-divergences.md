...
- [ ] Re-run all three reproductions. (Each passed when its fix landed; they must be re-run against the FINAL binary, after the golden regeneration and the byte-identity fixture change, before this box is ticked.)
