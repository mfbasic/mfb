...
- When compiler work adds, removes, renames, renumbers, or reclassifies any error code or diagnostic rule, update `specifications/error_codes.md`, `specifications/mfbasic.md`, and `specifications/standard_package.md` in the same change so the docs match the compiler source of truth.
