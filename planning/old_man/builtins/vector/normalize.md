...
[[src/codegen/builtins/vector/package.mfb:__vector_normalize_float3]]
...
[[src/codegen/builtins/vector/package.mfb:__vector_normalize_float2]]
...
[[src/codegen/builtins/vector/package.mfb:__vector_normalize_integer3]]
...
[[src/codegen/builtins/vector/package.mfb:__vector_normalize_integer2]]
...
| --- | --- | --- |
| `v` | one of the nine vector types | The vector to normalize. Must have a non-zero length. Also spelled `v` as a named argument. [[src/codegen/builtins/vector/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| the same type as `v` | A new vector of the same type and dimension pointing in the same direction as `v`. Magnitude `1` on the `Float` and `Fixed` overloads; on the `Integer` overloads a lattice-rounded approximation whose components are each `-1`, `0`, or `1`. [[src/codegen/builtins/vector/mod.rs:VECTOR]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `v` has zero length, so it has no direction to preserve. [[src/codegen/builtins/vector/package.mfb:__vector_normalize_float2]] |
