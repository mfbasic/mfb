...
| `77050015` | `ErrFloatOverflow` | On the `Float` overloads, a squared component or the sum reaches infinity and is caught where the result is returned. [[src/codegen/builtins/errorcode/mod.rs:ErrFloatOverflow]] |
