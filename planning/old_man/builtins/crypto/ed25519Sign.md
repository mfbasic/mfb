...
[[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Sign]]
...
caller. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Sign]]
...
| --- | --- | --- |
| `privateKey` | `List OF Byte` | The 32-byte Ed25519 secret seed (the `privateKey` field of a `crypto::generateEd25519` key pair). Must be exactly 32 bytes. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Sign]] |
...
| Type | Description |
| --- | --- |
| `List OF Byte` | The 64-byte Ed25519 signature: the 32-byte `R` point followed by the 32-byte `S` scalar. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Sign]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77050002` | `ErrInvalidArgument` | `privateKey` is not exactly 32 bytes long. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Sign]] |
