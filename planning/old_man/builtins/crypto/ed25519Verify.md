...
[[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Verify]]
...
scalar. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Verify]]
...
[[src/codegen/builtins/crypto/package.mfb:__crypto_constantTimeEqual]]

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| `publicKey` | `List OF Byte` | The Ed25519 public key (the `publicKey` field of a `crypto::generateEd25519` key pair). Any length other than exactly 32 bytes yields a `FALSE` verdict. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Verify]] |
...
| `signature` | `List OF Byte` | The candidate signature. Any length other than exactly 64 bytes yields a `FALSE` verdict. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Verify]] |

## Return value

| Type | Description |
| --- | --- |
| `Boolean` | `TRUE` if `signature` is a valid Ed25519 signature of `message` under `publicKey`; `FALSE` otherwise (including a mis-sized key or signature). A `FALSE` result is a normal outcome, not an error. [[src/codegen/builtins/crypto/package.mfb:__crypto_ed25519Verify]] |
