...
zero. [[src/codegen/builtins/bits/func_rr32.rs:lower_bits_rr32]]
...
[[src/codegen/builtins/bits/func_rr32.rs:lower_bits_rr32]]
...
[[src/codegen/builtins/bits/func_rr32.rs:lower_bits_rr32]] [[src/target/shared/abi.rs:rotate_right_word_registers]]

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| `value` | `Integer` | The value whose low 32 bits are rotated. Bits 32..63 are ignored; treated as a raw bit pattern. [[src/codegen/registry/mod.rs:call_param_names]] |
| `count` | `Integer` | The number of bit positions to rotate right, reduced modulo 32. Any value, including negative counts, is accepted. [[src/codegen/builtins/bits/func_rr32.rs:lower_bits_rr32]] |

## Return value

| Type | Description |
| --- | --- |
| `Integer` | The low 32 bits of `value` rotated right by `count MOD 32`, zero-extended into bits 32..63. Equal to the low 32 bits of `value` when `count` is a multiple of 32. [[src/codegen/builtins/bits/mod.rs:register]] |
