...
execution paths. [[src/codegen/builtins/bits/mod.rs:register]] [[src/codegen/builtins/bits/func_bxor.rs:lower_bits_bxor]] [[src/target/shared/abi.rs:exclusive_or_registers]]
...
| Type | Description |
| --- | --- |
| `Integer` | The bitwise XOR of `a` and `b`. `0` when the operands are equal; equal to either operand when the other is `0`. [[src/codegen/builtins/bits/mod.rs:register]] |
