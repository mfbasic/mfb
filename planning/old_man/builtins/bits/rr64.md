...
the result is forced to zero. [[src/codegen/builtins/bits/func_rr64.rs:lower_bits_rr64]]
...
[[src/codegen/builtins/bits/func_rr64.rs:lower_bits_rr64]]
...
execution paths.
[[src/codegen/builtins/bits/func_rr64.rs:lower_bits_rr64]] [[src/target/shared/abi.rs:rotate_right_registers]]

## Parameters

| Parameter | Type | Description |
| --- | --- | --- |
| `value` | `Integer` | The value whose 64 bits are rotated. Treated as a raw bit pattern. [[src/codegen/registry/mod.rs:call_param_names]] |
| `count` | `Integer` | The number of bit positions to rotate right, reduced modulo 64. Any value, including negative counts, is accepted. [[src/codegen/builtins/bits/func_rr64.rs:lower_bits_rr64]] |

## Return value

| Type | Description |
| --- | --- |
| `Integer` | All 64 bits of `value` rotated right by `count MOD 64`. Equal to `value` when `count` is a multiple of 64. [[src/codegen/builtins/bits/mod.rs:register]] |
