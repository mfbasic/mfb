...
zero. [[src/codegen/builtins/bits/func_rl32.rs:lower_bits_rl32]]
...
[[src/codegen/builtins/bits/func_rl32.rs:lower_bits_rl32]]
...
execution paths. [[src/codegen/builtins/bits/func_rl32.rs:lower_bits_rl32]]
...
| `count` | `Integer` | The number of bit positions to rotate left, reduced modulo 32. Any value, including negative counts, is accepted. [[src/codegen/builtins/bits/func_rl32.rs:lower_bits_rl32]] |

## Return value

| Type | Description |
| --- | --- |
| `Integer` | The low 32 bits of `value` rotated left by `count MOD 32`, zero-extended into bits 32..63. Equal to the low 32 bits of `value` when `count` is a multiple of 32. [[src/codegen/builtins/bits/mod.rs:register]] |
