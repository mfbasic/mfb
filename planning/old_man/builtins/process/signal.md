...
`SIGABRT`. [[src/codegen/builtins/process/func_signal.rs:lower_process_signal_helper_posix]]
...
`mfb man process types`. [[src/codegen/builtins/process/func_signal.rs:lower_process_signal_helper_win]]
