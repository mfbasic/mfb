...
without stalling on the device. [[src/codegen/builtins/audio/native/macos.rs:lower_query]][[src/codegen/builtins/audio/native/alsa.rs:lower_query]]
...
[[src/codegen/builtins/audio/native/alsa.rs:lower_query]][[src/codegen/builtins/audio/native/macos.rs:lower_query]]
...
than raising an error, so `available` is always safe to call. [[src/codegen/builtins/audio/native/macos.rs:lower_query]][[src/codegen/builtins/audio/native/alsa.rs:lower_query]]
...
[[src/codegen/builtins/audio/native/alsa.rs:emit_dlopen]][[src/codegen/builtins/audio/native/alsa.rs:lower_query]]

## Overloads

**`audio::available(stream AS audio::AudioInput)`**

Frames currently readable from the capture stream without blocking. [[src/codegen/builtins/audio/mod.rs:register]]
...
runtime. [[src/codegen/builtins/audio/mod.rs:register]][[src/codegen/builtins/audio/native/macos.rs:lower_query]]
...
| Type | Description |
| --- | --- |
| `Integer` | Frames readable (input) or writable (output) without blocking; never negative — a negative device count is clamped to `0`, as is a closed or defaulted handle. [[src/codegen/builtins/audio/mod.rs:register]][[src/codegen/builtins/audio/native/alsa.rs:lower_query]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77050017` | `ErrAudioUnavailable` | Linux only: `libasound.so.2` (or a required symbol such as `snd_pcm_avail_update`) could not be resolved at runtime. macOS never raises this. [[src/codegen/builtins/audio/native/alsa.rs:lower_query]][[src/codegen/builtins/errorcode/mod.rs:ErrAudioUnavailable]] |
