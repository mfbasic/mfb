...
| --- | --- | --- |
| `77020003` | `ErrEof` | Standard input reaches end of input before the lead byte is read. [[src/codegen/builtins/errorcode/mod.rs:ErrEndOfFile]] |
| `77020004` | `ErrEncoding` | The bytes read are not a valid UTF-8 scalar — a bad lead or continuation byte, an overlong form, a surrogate encoding, a value above U+10FFFF, or a sequence truncated by end of input. [[src/codegen/builtins/errorcode/mod.rs:ErrEncoding]] |
...
| `77010001` | `ErrOutOfMemory` | The returned `String` cannot be allocated. [[src/codegen/builtins/errorcode/mod.rs:ErrOutOfMemory]] |
