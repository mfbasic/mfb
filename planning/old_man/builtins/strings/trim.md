...
| --- | --- | --- |
| `value` | `String` | The string to trim. Any `String` is accepted, including the empty string and a string that is entirely whitespace. [[src/codegen/registry/mod.rs:call_param_names]] |

## Return value

| Type | Description |
| --- | --- |
| `String` | A new `String` equal to `value` with leading and trailing Unicode whitespace removed. The empty string, and any all-whitespace string, yield `""`. [[src/codegen/builtins/strings/mod.rs:register]] |
