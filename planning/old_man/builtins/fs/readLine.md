...
| `77010001` | `ErrOutOfMemory` | The read block, the line accumulator, or the `String` holding the returned line cannot be allocated. [[src/codegen/builtins/errorcode/mod.rs:ErrOutOfMemory]] |
