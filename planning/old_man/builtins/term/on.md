...
`term::on` takes no parameters. [[src/codegen/registry/mod.rs:call_param_names]]

## Return value

| Type | Description |
| --- | --- |
| `Nothing` | Returns nothing. The call is made for its side effect of entering TUI mode. [[src/codegen/builtins/term/mod.rs:register]] |

## Errors

| Code | Name | Raised when |
| --- | --- | --- |
| `77010001` | `ErrOutOfMemory` | The shadow-grid block sized to the terminal cannot be allocated. TUI mode is not entered and the terminal is left untouched. [[src/codegen/builtins/errorcode/mod.rs:ErrOutOfMemory]] |
