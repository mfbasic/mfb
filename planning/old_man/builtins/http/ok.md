...
`TRUE`. [[src/codegen/builtins/http/package.mfb:__http_ok]]
[[src/codegen/builtins/http/package.mfb:__http_responseWith]] [[src/codegen/builtins/http/func_ok.rs:ok]]
...
| Type | Description |
| --- | --- |
| `Response` | A new response with `status` `200`, `reason` `""`, `httpVersion` `"1.1"`, `headers` containing only `content-type` → `"text/plain; charset=utf-8"`, `body` the UTF-8 bytes of `body`, and `ok` `TRUE`. [[src/codegen/builtins/http/package.mfb:__http_ok]] |
