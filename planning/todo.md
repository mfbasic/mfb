...
| 6 | XML | Pure MFB package — **in progress, plan-138** | See note below. `packages/xml` now reads XML 1.0 into a `UNION` tree and writes it back (plan-138-A and -B); the Node/Rust differential oracles and the XPath 1.0 subset are plan-138-C, -D and -E. |
