...
FUNC per const); `tools/vector-gen/check_vector_bodies.py` (run by
...
def main():
    blocks = []
    header = """' Reference MFBASIC for the built-in `vector` package (plan-06-vector.md): its FUNC
' bodies are gated against the BODY consts in src/codegen/builtins/vector/ by
' tools/vector-gen/check_vector_bodies.py.
' GENERATED by tools/vector-gen/gen_vector_package.py — do not edit by hand; edit the
